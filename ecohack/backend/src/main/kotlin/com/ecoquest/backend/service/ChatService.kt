...
class ChatService(
    ...
    private fun fallbackReply(message: String): String {
        ...
        return when {
            lower.containsAny("recycle", "recycling") ->
            ...
            lower.containsAny("water", "save water") ->
            ...
            lower.containsAny("energy", "electricity") ->
            ...
            lower.containsAny("clean", "cleanup", "trash", "litter") ->
            ...
            lower.containsAny("tip", "advice", "help", "suggest") ->
